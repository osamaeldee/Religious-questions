...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers1/Show%20anser5.dart';
...
class PageWithContainers4 extends StatefulWidget {
  @override
  _PageWithContainers4State createState() => _PageWithContainers4State();
}

class _PageWithContainers4State extends State<PageWithContainers4> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers[3];
  List<String> question = questions[3];
  String correct = "الكعبة";
  @override
          ...
          CountdownWidget(
            onZeroReached: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers5());
              });
            },
          ),
        ],
