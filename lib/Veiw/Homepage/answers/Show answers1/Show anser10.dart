...
class PageWithContainers10 extends StatefulWidget {
  @override
  _PageWithContainers9State createState() => _PageWithContainers9State();
}

class _PageWithContainers9State extends State<PageWithContainers10> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers[9];
  List<String> question = questions[9];
  String correct = "الصيام";
