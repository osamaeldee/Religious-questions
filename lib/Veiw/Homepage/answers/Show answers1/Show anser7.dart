...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers1/Show%20anser8.dart';
...
class PageWithContainers7 extends StatefulWidget {
  @override
  _PageWithContainers7State createState() => _PageWithContainers7State();
}

class _PageWithContainers7State extends State<PageWithContainers7> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers[6];
  List<String> question = questions[6];
  String correct = "الحج";
          ...
          CountdownWidget(
            onZeroReached: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers8());
              });
            },
          ),
        ],
