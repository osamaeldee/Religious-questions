...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers1/Show%20anser3.dart';
...
class PageWithContainers2 extends StatefulWidget {
  @override
  _PageWithContainers2State createState() => _PageWithContainers2State();
}

class _PageWithContainers2State extends State<PageWithContainers2> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers[1];
  List<String> question = questions[1];
  String correct = "محمد";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers3());
              });
            },
            text: "موافق",
          )
