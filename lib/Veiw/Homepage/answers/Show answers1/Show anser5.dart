...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers1/Show%20anser6.dart';
...
class PageWithContainers5 extends StatefulWidget {
  @override
  _PageWithContainers5State createState() => _PageWithContainers5State();
}

class _PageWithContainers5State extends State<PageWithContainers5> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers[4];
  List<String> question = questions[4];
  String correct = "الزكاة";
          ...
          CountdownWidget(
            onZeroReached: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers6());
              });
            },
          ),
        ],
