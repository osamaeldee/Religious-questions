...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers1/Show%20anser7.dart';
...
class PageWithContainers6 extends StatefulWidget {
  @override
  _PageWithContainers6State createState() => _PageWithContainers6State();
}

class _PageWithContainers6State extends State<PageWithContainers6> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers[5];
  List<String> question = questions[5];
  String correct = "عيد الفطر";
          ...
          CountdownWidget(
            onZeroReached: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers7());
              });
            },
          ),
        ],
