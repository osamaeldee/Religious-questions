...
class PageWithContainers9 extends StatefulWidget {
  @override
  _PageWithContainers9State createState() => _PageWithContainers9State();
}

class _PageWithContainers9State extends State<PageWithContainers9> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers[8];
  List<String> question = questions[8];
  String correct = "إبراهيم";
