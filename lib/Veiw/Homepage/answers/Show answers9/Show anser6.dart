...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers9/Show%20anser7.dart';
...
class PageWithContainers6S9 extends StatefulWidget {
  @override
  _PageWithContainers6S9State createState() => _PageWithContainers6S9State();
}

class _PageWithContainers6S9State extends State<PageWithContainers6S9> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers8[5];
  List<String> question = questions8[5];
  String corr = "عمر بن خطاب";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers7S9());
              });
            },
            text: "موافق",
          )
