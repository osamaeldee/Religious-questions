...
class PageWithContainers10S9 extends StatefulWidget {
  @override
  _PageWithContainers9State createState() => _PageWithContainers9State();
}

class _PageWithContainers9State extends State<PageWithContainers10S9> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers8[9];
  List<String> question = questions8[9];

  String corr = "لعكاشة بن محصن";
  @override
