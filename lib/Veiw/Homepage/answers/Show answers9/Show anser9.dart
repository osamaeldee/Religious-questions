...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers9/Show%20anser10.dart';
...
class PageWithContainers9S9 extends StatefulWidget {
  @override
  _PageWithContainers9S9State createState() => _PageWithContainers9S9State();
}

class _PageWithContainers9S9State extends State<PageWithContainers9S9> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers8[8];
  List<String> question = questions8[8];
  String corr = "معاذ بن جبل";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers10S9());
              });
            },
            text: "موافق",
          )
