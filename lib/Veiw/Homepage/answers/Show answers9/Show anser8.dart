...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers9/Show%20anser9.dart';
...
class PageWithContainers8S9 extends StatefulWidget {
  @override
  _PageWithContainersState createState() => _PageWithContainersState();
}

class _PageWithContainersState extends State<PageWithContainers8S9> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers8[7];
  List<String> question = questions8[7];
  String corr = "سعد بن خيثمة";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers9S9());
              });
            },
            text: "موافق",
          )
