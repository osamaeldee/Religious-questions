...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers9/Show%20anser5.dart';
...
class PageWithContainers4S9 extends StatefulWidget {
  @override
  _PageWithContainers4S9State createState() => _PageWithContainers4S9State();
}

class _PageWithContainers4S9State extends State<PageWithContainers4S9> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers8[3];
  List<String> question = questions8[3];
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers5S9());
              });
            },
            text: "موافق",
          ),
