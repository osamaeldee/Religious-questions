...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers9/Show_anser2.dart';
...
import '../../../../json/Lists/List of questions/ninelist.dart';

class PageWithContainersS9 extends StatefulWidget {
  @override
  _PageWithContainersState createState() => _PageWithContainersState();
}

class _PageWithContainersState extends State<PageWithContainersS9> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers8[0];
  List<String> question = questions8[0];
  String corr = "أبو هريرة";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers2S9());
              });
            },
            text: "موافق",
          )
