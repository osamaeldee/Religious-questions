...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers9/Show%20anser8.dart';
...
class PageWithContainers7S9 extends StatefulWidget {
  @override
  _PageWithContainers7S9State createState() => _PageWithContainers7S9State();
}

class _PageWithContainers7S9State extends State<PageWithContainers7S9> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers8[6];
  List<String> question = questions8[6];
  String corr = "خُزَيمة بِنُ ثابِت الأَنصارِي الأَوسِي";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers8S9());
              });
            },
            text: "موافق",
          )
