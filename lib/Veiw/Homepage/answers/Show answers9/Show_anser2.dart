...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers9/Show%20anser3.dart';
...
class PageWithContainers2S9 extends StatefulWidget {
  @override
  _PageWithContainers2S9State createState() => _PageWithContainers2S9State();
}

class _PageWithContainers2S9State extends State<PageWithContainers2S9> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers8[1];
  List<String> question = questions8[1];
  String corr = "عبد الله بن أبي السرح";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers3S9());
              });
            },
            text: "موافق",
          )
