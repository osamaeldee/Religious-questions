...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers9/Show%20anser6.dart';
...
class PageWithContainers5S9 extends StatefulWidget {
  @override
  _PageWithContainers5S9State createState() => _PageWithContainers5S9State();
}

class _PageWithContainers5S9State extends State<PageWithContainers5S9> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers8[4];
  List<String> question = questions8[4];
  String corr = "عروة بن أبي الجعد البارقي";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers6S9());
              });
            },
            text: "موافق",
          )
