...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers6/Show%20anser8.dart';
...
class PageWithContainers7S6 extends StatefulWidget {
  @override
  _PageWithContainers7S6State createState() => _PageWithContainers7S6State();
}

class _PageWithContainers7S6State extends State<PageWithContainers7S6> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers5[6];
  List<String> question = questions5[6];
  String cottect1 = "عثمان بن مظعون";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers8S6());
              });
            },
            text: "موافق",
          )
