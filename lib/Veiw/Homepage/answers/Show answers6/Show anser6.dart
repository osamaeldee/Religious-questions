...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers6/Show%20anser7.dart';
...
class PageWithContainers6S6 extends StatefulWidget {
  @override
  _PageWithContainers6S6State createState() => _PageWithContainers6S6State();
}

class _PageWithContainers6S6State extends State<PageWithContainers6S6> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers5[5];
  List<String> question = questions5[5];
  String cottect1 = "علي بن أبي طالب";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers7S6());
              });
            },
            text: "موافق",
          )
