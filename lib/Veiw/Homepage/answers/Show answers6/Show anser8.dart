...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers6/Show%20anser9.dart';
...
class PageWithContainers8S6 extends StatefulWidget {
  @override
  _PageWithContainersState createState() => _PageWithContainersState();
}

class _PageWithContainersState extends State<PageWithContainers8S6> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers5[7];
  List<String> question = questions5[7];
  String cottect1 = "زيد بن حارثة";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers9S6());
              });
            },
            text: "موافق",
          )
