...
class PageWithContainers10S6 extends StatefulWidget {
  @override
  _PageWithContainers9State createState() => _PageWithContainers9State();
}

class _PageWithContainers9State extends State<PageWithContainers10S6> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers5[9];
  List<String> question = questions5[9];
  String cottect1 = "الزبير بن العوام";
