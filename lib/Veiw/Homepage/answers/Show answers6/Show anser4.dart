...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers6/Show%20anser5.dart';
...
class PageWithContainers4S6 extends StatefulWidget {
  @override
  _PageWithContainers4S6State createState() => _PageWithContainers4S6State();
}

class _PageWithContainers4S6State extends State<PageWithContainers4S6> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers5[3];
  List<String> question = questions5[3];
  String cottect1 = "عمر بن الخطاب";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers5S6());
              });
            },
            text: "موافق",
          ),
