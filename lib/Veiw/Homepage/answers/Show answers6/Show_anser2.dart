...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers6/Show%20anser3.dart';
...
class PageWithContainers2S6 extends StatefulWidget {
  @override
  _PageWithContainers2S6State createState() => _PageWithContainers2S6State();
}

class _PageWithContainers2S6State extends State<PageWithContainers2S6> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers5[1];
  List<String> question = questions5[1];
  String cottect1 = "عثمان بن عفان";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers3S6());
              });
            },
            text: "موافق",
          )
