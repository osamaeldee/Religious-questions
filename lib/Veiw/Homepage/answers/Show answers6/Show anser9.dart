...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers6/Show%20anser10.dart';
...
class PageWithContainers9S6 extends StatefulWidget {
  @override
  _PageWithContainers9S6State createState() => _PageWithContainers9S6State();
}

class _PageWithContainers9S6State extends State<PageWithContainers9S6> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers5[8];
  List<String> question = questions5[8];
  String cottect1 = "حذيفة بن اليمان";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers10S6());
              });
            },
            text: "موافق",
          )
