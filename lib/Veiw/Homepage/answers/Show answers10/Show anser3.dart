...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers10/Show%20anser4.dart';
...
class PageWithContainers3S10 extends StatefulWidget {
  @override
  _PageWithContainers3S10State createState() => _PageWithContainers3S10State();
}

class _PageWithContainers3S10State extends State<PageWithContainers3S10> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers9[2];
  List<String> question = questions9[2];
  String correct = "آية الدَّيْن";
  @override
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers4S10());
              });
            },
            text: "موافق",
          )
