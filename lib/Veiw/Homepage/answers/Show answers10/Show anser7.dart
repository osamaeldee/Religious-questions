...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers10/Show%20anser8.dart';
...
class PageWithContainers7S10 extends StatefulWidget {
  @override
  _PageWithContainers7S10State createState() => _PageWithContainers7S10State();
}

class _PageWithContainers7S10State extends State<PageWithContainers7S10> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers9[6];
  List<String> question = questions9[6];
  String correct = "ذا الكفل";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers8S10());
              });
            },
            text: "موافق",
          )
