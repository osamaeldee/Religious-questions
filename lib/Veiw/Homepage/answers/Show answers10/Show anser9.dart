...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers10/Show%20anser10.dart';
...
class PageWithContainers9S10 extends StatefulWidget {
  @override
  _PageWithContainers9S10State createState() => _PageWithContainers9S10State();
}

class _PageWithContainers9S10State extends State<PageWithContainers9S10> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers9[8];
  List<String> question = questions9[8];
  String correct = "المتردي";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers10S10());
              });
            },
            text: "موافق",
          )
