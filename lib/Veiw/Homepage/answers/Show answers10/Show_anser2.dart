...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers10/Show%20anser3.dart';
...
class PageWithContainers2S10 extends StatefulWidget {
  @override
  _PageWithContainers2S10State createState() => _PageWithContainers2S10State();
}

class _PageWithContainers2S10State extends State<PageWithContainers2S10> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers9[1];
  List<String> question = questions9[1];
  String corr = "جهاد في سبيل الله";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers3S10());
              });
            },
            text: "موافق",
          )
