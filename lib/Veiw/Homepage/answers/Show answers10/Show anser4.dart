...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers10/Show%20anser5.dart';
...
class PageWithContainers4S10 extends StatefulWidget {
  @override
  _PageWithContainers4S10State createState() => _PageWithContainers4S10State();
}

class _PageWithContainers4S10State extends State<PageWithContainers4S10> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers9[3];
  List<String> question = questions9[3];
  String correct = "الإعدام";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers5S10());
              });
            },
            text: "موافق",
          ),
