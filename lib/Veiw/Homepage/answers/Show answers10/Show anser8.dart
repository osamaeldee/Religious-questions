...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers10/Show%20anser9.dart';
...
class PageWithContainers8S10 extends StatefulWidget {
  @override
  _PageWithContainersState createState() => _PageWithContainersState();
}

class _PageWithContainersState extends State<PageWithContainers8S10> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers9[7];
  List<String> question = questions9[7];
  String correct = "قتيبة بن مسلم";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers9S10());
              });
            },
            text: "موافق",
          )
