...
import 'package:restaurant_project/Veiw/Homepage/evaluation/evaluation1En.dart';
...
class PageWithContainers10S10 extends StatefulWidget {
  @override
  _PageWithContainers9State createState() => _PageWithContainers9State();
}

class _PageWithContainers9State extends State<PageWithContainers10S10> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers9[9];
  List<String> question = questions9[9];
  String correct = "واجبة وشرطها السلامة والعافية";
