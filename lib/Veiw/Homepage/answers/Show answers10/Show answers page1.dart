...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers10/Show_anser2.dart';
...
class PageWithContainersS10 extends StatefulWidget {
  @override
  _PageWithContainersS10State createState() => _PageWithContainersS10State();
}

class _PageWithContainersS10State extends State<PageWithContainersS10> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers9[0];
  List<String> question = questions9[0];
  String correct = "أربعة شهود";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers2S10());
              });
            },
            text: "موافق",
          )
