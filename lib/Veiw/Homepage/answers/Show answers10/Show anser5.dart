...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers10/Show%20anser6.dart';
...
class PageWithContainers5S10 extends StatefulWidget {
  @override
  _PageWithContainers5S10State createState() => _PageWithContainers5S10State();
}

class _PageWithContainers5S10State extends State<PageWithContainers5S10> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers9[4];
  List<String> question = questions9[4];
  String correct = "حرام";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers6S10());
              });
            },
            text: "موافق",
          )
