...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers8/Show%20anser8.dart';
...
class PageWithContainers7S8 extends StatefulWidget {
  @override
  _PageWithContainers7S8State createState() => _PageWithContainers7S8State();
}

class _PageWithContainers7S8State extends State<PageWithContainers7S8> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers7[6];
  List<String> question = questions7[6];
  String corr = "حسان بن ثابت";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers8S8());
              });
            },
            text: "موافق",
          )
