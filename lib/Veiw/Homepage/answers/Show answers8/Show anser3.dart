...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers1/Show%20anser4.dart';
...
class PageWithContainers3S8 extends StatefulWidget {
  @override
  _PageWithContainers3S8State createState() => _PageWithContainers3S8State();
}

class _PageWithContainers3S8State extends State<PageWithContainers3S8> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers7[2];
  List<String> question = questions7[2];
  String corr = "عبد الله بن عباس";
