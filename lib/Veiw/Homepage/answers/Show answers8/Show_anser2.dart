...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers8/Show%20anser3.dart';
...
class PageWithContainers2S8 extends StatefulWidget {
  @override
  _PageWithContainers2S8State createState() => _PageWithContainers2S8State();
}

class _PageWithContainers2S8State extends State<PageWithContainers2S8> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers7[1];
  List<String> question = questions7[1];
  String corr = "اللهم إني أشهدك أني أشهد أنه رسول الله";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers3S8());
              });
            },
            text: "موافق",
          )
