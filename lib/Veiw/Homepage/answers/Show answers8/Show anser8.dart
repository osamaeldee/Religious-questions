...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers8/Show%20anser9.dart';
...
class PageWithContainers8S8 extends StatefulWidget {
  @override
  _PageWithContainersState createState() => _PageWithContainersState();
}

class _PageWithContainersState extends State<PageWithContainers8S8> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers7[7];
  List<String> question = questions7[7];
  String corr = "أبو سلمة نعيم بن مسعود";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers9S8());
              });
            },
            text: "موافق",
          )
