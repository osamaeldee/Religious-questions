...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers8/Show%20anser5.dart';
...
class PageWithContainers4S8 extends StatefulWidget {
  @override
  _PageWithContainers4S8State createState() => _PageWithContainers4S8State();
}

class _PageWithContainers4S8State extends State<PageWithContainers4S8> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers7[3];
  List<String> question = questions7[3];
  String corr = "طلحة بن عبيد الله ";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers5S8());
              });
            },
            text: "موافق",
          ),
