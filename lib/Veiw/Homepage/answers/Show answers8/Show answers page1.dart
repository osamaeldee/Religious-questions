...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers8/Show_anser2.dart';
...
class PageWithContainersS8 extends StatefulWidget {
  @override
  _PageWithContainersS8State createState() => _PageWithContainersS8State();
}

class _PageWithContainersS8State extends State<PageWithContainersS8> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers7[0];
  List<String> question = questions7[0];
  String corr = "علي بن أبي طالب";
  @override
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers2S8());
              });
            },
            text: "موافق",
          )
