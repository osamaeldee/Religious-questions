...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers8/Show%20anser6.dart';
...
class PageWithContainers5S8 extends StatefulWidget {
  @override
  _PageWithContainers5S8State createState() => _PageWithContainers5S8State();
}

class _PageWithContainers5S8State extends State<PageWithContainers5S8> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers7[4];
  List<String> question = questions7[4];
  String corr = "سلمان الفارسي";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers6S8());
              });
            },
            text: "موافق",
          )
