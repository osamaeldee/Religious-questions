...
class PageWithContainers10S3 extends StatefulWidget {
  @override
  _PageWithContainers9State createState() => _PageWithContainers9State();
}

class _PageWithContainers9State extends State<PageWithContainers10S3> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers2[9];
  List<String> question = questions2[9];
  String correct1 = "14 هـ - سعد بن أبي وقاص";
