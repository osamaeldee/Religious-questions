...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers3/Show%20anser3.dart';
...
class PageWithContainers2S3 extends StatefulWidget {
  @override
  _PageWithContainers2S3State createState() => _PageWithContainers2S3State();
}

class _PageWithContainers2S3State extends State<PageWithContainers2S3> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers2[1];
  List<String> question = questions2[1];

  String correct1 = "عبد الملك بن مروان";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers3S3());
              });
            },
            text: "موافق",
          )
