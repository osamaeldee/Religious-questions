...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers3/Show%20anser10.dart';
...
class PageWithContainers9S3 extends StatefulWidget {
  @override
  _PageWithContainers9S3State createState() => _PageWithContainers9S3State();
}

class _PageWithContainers9S3State extends State<PageWithContainers9S3> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers2[8];
  List<String> question = questions2[8];
  String correct1 = "عبد الله بن عباس";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers10S3());
              });
            },
            text: "موافق",
          )
