...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers3/Show%20anser5.dart';
...
class PageWithContainers4S3 extends StatefulWidget {
  @override
  _PageWithContainers4S3State createState() => _PageWithContainers4S3State();
}

class _PageWithContainers4S3State extends State<PageWithContainers4S3> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers2[3];
  List<String> question = questions2[3];
  String correct1 = "بدر - النبي محمد ﷺ";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers5S3());
              });
            },
            text: "موافق",
          ),
