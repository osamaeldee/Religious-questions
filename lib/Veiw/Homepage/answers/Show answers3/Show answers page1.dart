...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers3/Show_anser2.dart';
...
class PageWithContainersS3 extends StatefulWidget {
  @override
  _PageWithContainersS3State createState() => _PageWithContainersS3State();
}

class _PageWithContainersS3State extends State<PageWithContainersS3> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers2[0];
  List<String> question = questions2[0];
  String correct1 = "البقرة: 230";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers2S3());
              });
            },
            text: "موافق",
          )
