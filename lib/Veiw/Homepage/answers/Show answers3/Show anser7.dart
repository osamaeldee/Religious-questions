...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers3/Show%20anser8.dart';
...
class PageWithContainers7S3 extends StatefulWidget {
  @override
  _PageWithContainers7State createState() => _PageWithContainers7State();
}

class _PageWithContainers7State extends State<PageWithContainers7S3> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers2[6];
  List<String> question = questions2[6];
  String correct1 = "النور";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers8S3());
              });
            },
            text: "موافق",
          )
