...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers3/Show%20anser6.dart';
...
class PageWithContainers5S3 extends StatefulWidget {
  @override
  _PageWithContainers5State createState() => _PageWithContainers5State();
}

class _PageWithContainers5State extends State<PageWithContainers5S3> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers2[4];
  List<String> question = questions2[4];
  String correct1 = "25";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers6S3());
              });
            },
            text: "موافق",
          )
