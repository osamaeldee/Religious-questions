...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers3/Show%20anser9.dart';
...
class PageWithContainers8S3 extends StatefulWidget {
  @override
  _PageWithContainersState createState() => _PageWithContainersState();
}

class _PageWithContainersState extends State<PageWithContainers8S3> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers2[7];
  List<String> question = questions2[7];
  String correct1 = "المأمون";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers9S3());
              });
            },
            text: "موافق",
          )
