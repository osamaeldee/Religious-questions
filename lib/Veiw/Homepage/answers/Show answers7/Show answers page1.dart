...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers7/Show_anser2.dart';
...
class PageWithContainersS7 extends StatefulWidget {
  @override
  _PageWithContainersS7State createState() => _PageWithContainersS7State();
}

class _PageWithContainersS7State extends State<PageWithContainersS7> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers6[0];
  List<String> question = questions6[0];
  String cortect1 = "خالد بن الوليد";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers2S7());
              });
            },
            text: "موافق",
          )
