...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers7/Show%20anser3.dart';
...
class PageWithContainers2S7 extends StatefulWidget {
  @override
  _PageWithContainers2S7State createState() => _PageWithContainers2S7State();
}

class _PageWithContainers2S7State extends State<PageWithContainers2S7> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers6[1];
  List<String> question = questions6[1];
  String cortect1 = "سعيدُ بنُ زيدِ بنُ عمرو";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers3S7());
              });
            },
            text: "موافق",
          )
