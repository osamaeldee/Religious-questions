...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers7/Show%20anser8.dart';
...
class PageWithContainers7S7 extends StatefulWidget {
  @override
  _PageWithContainers7S7State createState() => _PageWithContainers7S7State();
}

class _PageWithContainers7S7State extends State<PageWithContainers7S7> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers6[6];
  List<String> question = questions6[6];
  String cortect1 = "بلال بن رباح";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers8S7());
              });
            },
            text: "موافق",
          )
