...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers7/Show%20anser4.dart';
...
class PageWithContainers3S7 extends StatefulWidget {
  @override
  _PageWithContainers3S7State createState() => _PageWithContainers3S7State();
}

class _PageWithContainers3S7State extends State<PageWithContainers3S7> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers6[2];
  List<String> question = questions6[2];
  String cortect1 = "عبد الله بن عباس";
  @override
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers4S7());
              });
            },
            text: "موافق",
          )
