...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers7/Show%20anser6.dart';
...
class PageWithContainers5S7 extends StatefulWidget {
  @override
  _PageWithContainers5S7State createState() => _PageWithContainers5S7State();
}

class _PageWithContainers5S7State extends State<PageWithContainers5S7> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers6[4];
  List<String> question = questions6[4];
  String cortect1 = "علي بن أبي طالب";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers6S7());
              });
            },
            text: "موافق",
          )
