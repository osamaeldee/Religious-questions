...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers7/Show%20anser7.dart';
...
class PageWithContainers6S7 extends StatefulWidget {
  @override
  _PageWithContainers6S7State createState() => _PageWithContainers6S7State();
}

class _PageWithContainers6S7State extends State<PageWithContainers6S7> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers6[5];
  List<String> question = questions6[5];
  String cortect1 = "زيد بن حارثة";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers7S7());
              });
            },
            text: "موافق",
          )
