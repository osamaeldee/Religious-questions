...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers7/Show%20anser5.dart';
...
class PageWithContainers4S7 extends StatefulWidget {
  @override
  _PageWithContainers4S7State createState() => _PageWithContainers4S7State();
}

class _PageWithContainers4S7State extends State<PageWithContainers4S7> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers6[3];
  List<String> question = questions6[3];
  String cortect1 = "عثمان بن عفان";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers5S7);
              });
            },
            text: "موافق",
          ),
