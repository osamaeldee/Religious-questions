...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers4/Show%20anser7.dart';
...
class PageWithContainers6S4 extends StatefulWidget {
  @override
  _PageWithContainers6S4State createState() => _PageWithContainers6S4State();
}

class _PageWithContainers6S4State extends State<PageWithContainers6S4> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers3[5];
  List<String> question = questions3[5];
  String correct1 = "الخوارزمي";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers7S4());
              });
            },
            text: "موافق",
          )
