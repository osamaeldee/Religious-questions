...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers4/Show%20anser6.dart';
...
class PageWithContainers5S4 extends StatefulWidget {
  @override
  _PageWithContainers5S4State createState() => _PageWithContainers5S4State();
}

class _PageWithContainers5S4State extends State<PageWithContainers5S4> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers3[4];
  List<String> question = questions3[4];
  String correct1 = "الإمام أحمد بن حنبل";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers6S4());
              });
            },
            text: "موافق",
          )
