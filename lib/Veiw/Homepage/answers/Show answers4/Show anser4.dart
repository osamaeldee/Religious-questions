...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers4/Show%20anser5.dart';
...
class PageWithContainers4S4 extends StatefulWidget {
  @override
  _PageWithContainers4S4State createState() => _PageWithContainers4S4State();
}

class _PageWithContainers4S4State extends State<PageWithContainers4S4> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers3[3];
  List<String> question = questions3[3];
  String correct1 = "سورة الانبياء";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers5S4());
              });
            },
            text: "موافق",
          ),
