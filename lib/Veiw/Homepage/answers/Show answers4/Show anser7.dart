...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers4/Show%20anser8.dart';
...
class PageWithContainers7S4 extends StatefulWidget {
  @override
  _PageWithContainers7S4State createState() => _PageWithContainers7S4State();
}

class _PageWithContainers7S4State extends State<PageWithContainers7S4> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers3[6];
  List<String> question = questions3[6];
  String correct1 = "هارون";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers8S4());
              });
            },
            text: "موافق",
          )
