...
class PageWithContainers10S4 extends StatefulWidget {
  @override
  _PageWithContainers9State createState() => _PageWithContainers9State();
}

class _PageWithContainers9State extends State<PageWithContainers10S4> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers3[9];
  List<String> question = questions3[9];
  String correct1 = "إمرؤ القيس";
