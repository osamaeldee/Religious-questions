...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers4/Show%20anser4.dart';
...
class PageWithContainers3S4 extends StatefulWidget {
  @override
  _PageWithContainers3S4State createState() => _PageWithContainers3S4State();
}

class _PageWithContainers3S4State extends State<PageWithContainers3S4> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers3[2];
  List<String> question = questions3[2];
  String correct1 = "الفارابي";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers4S4());
              });
            },
            text: "موافق",
          )
