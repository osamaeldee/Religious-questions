...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers4/Show%20anser9.dart';
...
class PageWithContainers8S4 extends StatefulWidget {
  @override
  _PageWithContainersState createState() => _PageWithContainersState();
}

class _PageWithContainersState extends State<PageWithContainers8S4> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers3[7];
  List<String> question = questions3[7];
  String correct1 = "سورة التوبه";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers9S4());
              });
            },
            text: "موافق",
          )
