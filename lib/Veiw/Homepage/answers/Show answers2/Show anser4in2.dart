...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers2/Show%20anser5%20in2%20in2.dart';
...
class PageWithContainers4S2 extends StatefulWidget {
  @override
  _PageWithContainers4S2State createState() => _PageWithContainers4S2State();
}

class _PageWithContainers4S2State extends State<PageWithContainers4S2> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers1[3];
  List<String> question = questions1[3];
  String correct = "الامام الشفعي";
          ...
          CountdownWidget(
            onZeroReached: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers5S2());
              });
            },
          ),
        ],
