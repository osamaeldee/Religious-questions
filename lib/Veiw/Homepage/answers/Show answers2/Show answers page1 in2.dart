...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers2/Show_anser2%20in2.dart';
...
class PageWithContainersS2 extends StatefulWidget {
  @override
  _PageWithContainersState createState() => _PageWithContainersState();
}

class _PageWithContainersState extends State<PageWithContainersS2> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers1[0];
  List<String> question = questions1[0];
  String correct = "الوزغ";
  @override
          ...
          CountdownWidget(
            onZeroReached: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers2S2());
              });
            },
          ),
        ],
