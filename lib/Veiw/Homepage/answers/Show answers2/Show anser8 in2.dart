...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers2/Show%20anser9%20in2.dart';
...
class PageWithContainers8S2 extends StatefulWidget {
  @override
  _PageWithContainersState createState() => _PageWithContainersState();
}

class _PageWithContainersState extends State<PageWithContainers8S2> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers1[7];
  List<String> question = questions1[7];
  String correct = "اليهود";
          ...
          CountdownWidget(
            onZeroReached: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers9S2());
              });
            },
          ),
        ],
