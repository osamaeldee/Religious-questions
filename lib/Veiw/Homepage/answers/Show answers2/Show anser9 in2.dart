...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers2/Show%20anser10%20in2.dart';
...
class PageWithContainers9S2 extends StatefulWidget {
  @override
  _PageWithContainers9S2State createState() => _PageWithContainers9S2State();
}

class _PageWithContainers9S2State extends State<PageWithContainers9S2> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers1[8];
  List<String> question = questions1[8];
  String correct = '"اللهم انك عفو تحب العفو فاعف عنا"';
          ...
          CountdownWidget(
            onZeroReached: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers10S2());
              });
            },
          ),
        ],
