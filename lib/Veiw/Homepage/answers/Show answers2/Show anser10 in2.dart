...
class PageWithContainers10S2 extends StatefulWidget {
  @override
  _PageWithContainers9State createState() => _PageWithContainers9State();
}

class _PageWithContainers9State extends State<PageWithContainers10S2> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers1[9];
  List<String> question = questions1[9];
  String correct = "عمار بن ياسر";
