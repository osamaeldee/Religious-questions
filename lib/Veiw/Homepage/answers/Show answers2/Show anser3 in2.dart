...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers2/Show%20anser4in2.dart';
...
class PageWithContainers3S2 extends StatefulWidget {
  @override
  _PageWithContainers3S3State createState() => _PageWithContainers3S3State();
}

class _PageWithContainers3S3State extends State<PageWithContainers3S2> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers1[2];
  List<String> question = questions1[2];
  String correct = "ابي بن كعب";
          ...
          CountdownWidget(
            onZeroReached: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers4S2());
              });
            },
          ),
        ],
