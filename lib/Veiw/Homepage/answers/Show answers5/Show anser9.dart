...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers5/Show%20anser10.dart';
...
class PageWithContainers9S5 extends StatefulWidget {
  @override
  _PageWithContainers9S5State createState() => _PageWithContainers9S5State();
}

class _PageWithContainers9S5State extends State<PageWithContainers9S5> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers4[8];
  List<String> question = questions4[8];
  String correct1 = "البقره";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers10S5());
              });
            },
            text: "موافق",
          )
