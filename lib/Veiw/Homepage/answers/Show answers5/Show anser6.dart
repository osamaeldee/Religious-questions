...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers5/Show%20anser7.dart';
...
class PageWithContainers6S5 extends StatefulWidget {
  @override
  _PageWithContainers6S5State createState() => _PageWithContainers6S5State();
}

class _PageWithContainers6S5State extends State<PageWithContainers6S5> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers4[5];
  List<String> question = questions4[5];
  String correct1 = "ابن المقفع";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers7S5());
              });
            },
            text: "موافق",
          )
