...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers5/Show%20anser3.dart';
...
class PageWithContainers2S5 extends StatefulWidget {
  @override
  _PageWithContainers2S5State createState() => _PageWithContainers2S5State();
}

class _PageWithContainers2S5State extends State<PageWithContainers2S5> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers4[1];
  List<String> question = questions4[1];
  String correct1 = "محمد بن إدريس";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers3S5());
              });
            },
            text: "موافق",
          )
