...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers5/Show%20anser4.dart';
...
class PageWithContainers3S5 extends StatefulWidget {
  @override
  _PageWithContainers3S5State createState() => _PageWithContainers3S5State();
}

class _PageWithContainers3S5State extends State<PageWithContainers3S5> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers4[2];
  List<String> question = questions4[2];
  String correct1 = "ابن تيمية";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers4S5());
              });
            },
            text: "موافق",
          )
