...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers5/Show_anser2.dart';
...
class PageWithContainersS5 extends StatefulWidget {
  @override
  _PageWithContainersS5State createState() => _PageWithContainersS5State();
}

class _PageWithContainersS5State extends State<PageWithContainersS5> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers4[0];
  List<String> question = questions4[0];
  String correct1 = "ابن قدامة";
  @override
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers2S5());
              });
            },
            text: "موافق",
          )
