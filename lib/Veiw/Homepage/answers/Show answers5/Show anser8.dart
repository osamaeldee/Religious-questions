...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers5/Show%20anser9.dart';
...
class PageWithContainers8S5 extends StatefulWidget {
  @override
  _PageWithContainersState createState() => _PageWithContainersState();
}

class _PageWithContainersState extends State<PageWithContainers8S5> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers4[7];
  List<String> question = questions4[7];
  String correct1 = "عبد الرحمن الجزيري";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers9S5());
              });
            },
            text: "موافق",
          )
