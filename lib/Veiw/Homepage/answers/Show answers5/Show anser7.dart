...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers5/Show%20anser8.dart';
...
class PageWithContainers7S5 extends StatefulWidget {
  @override
  _PageWithContainers7S5State createState() => _PageWithContainers7S5State();
}

class _PageWithContainers7S5State extends State<PageWithContainers7S5> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers4[6];
  List<String> question = questions4[6];
  String correct1 = "أبو بكر الصديق";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers8S5());
              });
            },
            text: "موافق",
          )
