...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers5/Show%20anser5.dart';
...
class PageWithContainers4S5 extends StatefulWidget {
  @override
  _PageWithContainers4S5State createState() => _PageWithContainers4S5State();
}

class _PageWithContainers4S5State extends State<PageWithContainers4S5> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers4[3];
  List<String> question = questions4[3];
  String correct1 = "النمل";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(const Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers5S5());
              });
            },
            text: "موافق",
          ),
