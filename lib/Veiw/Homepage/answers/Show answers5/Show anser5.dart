...
import 'package:restaurant_project/Veiw/Homepage/answers/Show%20answers5/Show%20anser6.dart';
...
class PageWithContainers5S5 extends StatefulWidget {
  @override
  _PageWithContainers5S5State createState() => _PageWithContainers5S5State();
}

class _PageWithContainers5S5State extends State<PageWithContainers5S5> {
  String? selectedText;
  List<String> answersSubset = fakeAnswers4[4];
  List<String> question = questions4[4];
  String correct1 = "الزمخشري";
          ...
          MaterialButtoN(
            ontape: () {
              ...
              Future.delayed(Duration(milliseconds: 1000), () {
                Get.offAll(PageWithContainers6S5());
              });
            },
            text: "موافق",
          )
